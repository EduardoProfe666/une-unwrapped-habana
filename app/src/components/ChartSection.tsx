            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                {(Object.keys(CHART_LABELS) as ChartType[]).map((type) => (
                    <button
                        ...
                        className={`group relative cursor-pointer px-6 py-2 font-black uppercase tracking-tighter border-4 border-black hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all active:shadow-none ${
                            chartType === type
