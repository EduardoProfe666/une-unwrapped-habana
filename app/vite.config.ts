        ...
        plugins: [
            ...
            }),
            {
                ...
                closeBundle() {
                    ...
                    // NOTE: when a specific User-agent block is declared, strict
                    // parsers (including facebookexternalhit) treat it as
                    // OVERRIDING the wildcard block — not inheriting from it.
                    // So every crawler we care about gets its own explicit Allow.
                    const robotsContent = [
                        ...
                        'Allow: /',
                        '',
                        '# ─── Social link previews (OpenGraph / Twitter Card scrapers) ───',
